...
var filterByFormula = "&filterByFormula=%7Bvip_ou_50%7D%3D%22vip%22"

var url = "https://api.airtable.com/v0/appk3OIY3chtMfqK3/" + type + api_key + filterByFormula + perPage + maxRecords + "'";
...
async function catchJson() {
    ...
    if (response.status >= 200 && response.status < 400) {
        ...
        data.records.forEach(records => {
            ...
            records_length.innerHTML = 'Liste de coupons VIP <br> <h1> Il y a ' + data.records.length + ' coupons </h1> <a href="" class="button-2 left-aligned w-button"><span class="text-span-2">Ouvrir la Map</span></a>'
